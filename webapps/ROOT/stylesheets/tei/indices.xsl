...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="result/doc">
    <tr>
      ...
      <xsl:apply-templates select="str[@name='index_correspondence']"/>
      <xsl:apply-templates select="str[@name='index_word_type']"/>
      <xsl:apply-templates select="str[@name='index_word_subtype']"/>
      <xsl:apply-templates select="str[@name='index_morpheme_type']"/>
      <xsl:apply-templates select="str[@name='index_morpheme_subtype']"/>
      <xsl:apply-templates select="str[@name='index_syntagm_subtype']"/>
      <xsl:apply-templates select="str[@name='index_phoneme_subtype']"/>
      <xsl:apply-templates select="str[@name='index_quote_accuracy']"/>
  ...
  <xsl:template match="str[@name='index_correspondence']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>
  
  <xsl:template match="str[@name='index_word_type']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>
  
  <xsl:template match="str[@name='index_word_subtype']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>

  <xsl:template match="str[@name='index_morpheme_type']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>
  
  <xsl:template match="str[@name='index_morpheme_subtype']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>
  
  <xsl:template match="str[@name='index_syntagm_subtype']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>
  
  <xsl:template match="str[@name='index_phoneme_subtype']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>
  
  <xsl:template match="str[@name='index_quote_accuracy']">
    <td>
      <xsl:value-of select="."/>
    </td>
  </xsl:template>
